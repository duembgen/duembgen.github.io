...
This repository contains the source code for the personal website created based on Jekyll's default theme Minima. The below contents are from Minima's original README file, kept for configuration purposes during the development phase.
